...
- Shows a % positive/neutral/negative breakdown, common themes, and a scrollable list of real recent comments/reviews (negative ones surfaced first) with the provider icon, author name, star rating (Google Business), and sentiment label.
...
- Also feeds the Advisor tab's pulse (see above) as a "Comment sentiment" card and briefing input.
