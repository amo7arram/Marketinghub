...
- Renders hero image (if set) / headline / subheadline / body content / CTA button text from the fetched page, then a Name / Email / Phone form. Body content is sanitized (DOMPurify) before rendering — see the Landing Pages admin section above
